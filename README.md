...
<p align="center">
  ...
  <img alt="113 test suites" src="https://img.shields.io/badge/test%20suites-113-4ac26b?style=flat-square">
...
**Tests measure behaviour, never source text.** 113 suites plus 9 Python
...
```bash
npm test                  # 113 suites + 9 Python selftests (~16 min)
...
tests/               113 behaviour suites, mock upstreams, fake DOM
