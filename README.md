...
<p align="center">
  ...
  <img alt="112 test suites" src="https://img.shields.io/badge/test%20suites-112-4ac26b?style=flat-square">
...
**Tests measure behaviour, never source text.** 112 suites plus 9 Python
...
```bash
npm test                  # 112 suites + 9 Python selftests (~16 min)
...
```
server.js            router, chat, context assembly, streaming
lib/                 46 domain modules — one concern each, injected, no cycles
...
tests/               112 behaviour suites, mock upstreams, fake DOM
