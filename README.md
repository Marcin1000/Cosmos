...
<p align="center">
  ...
  <img alt="122 test suites" src="https://img.shields.io/badge/test%20suites-122-5E9E3A?style=flat-square">
...
**Tests measure behaviour, never source text.** 122 suites plus 9 Python
...
```bash
npm test                  # 122 suites + 9 Python selftests (~20 min)
...
tests/               122 behaviour suites, mock upstreams, fake DOM
