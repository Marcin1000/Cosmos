...
<p align="center">
  ...
  <img alt="111 test suites" src="https://img.shields.io/badge/test%20suites-111-4ac26b?style=flat-square">
...
**Tests measure behaviour, never source text.** 111 suites plus 9 Python
...
```bash
npm test                  # 111 suites + 9 Python selftests (~16 min)
...
tests/               111 behaviour suites, mock upstreams, fake DOM
