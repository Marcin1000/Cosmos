...
<p align="center">
  ...
  <img alt="96 test suites" src="https://img.shields.io/badge/test%20suites-96-4ac26b?style=flat-square">
...
**Tests measure behaviour, never source text.** 96 suites plus 9 Python
...
```bash
npm test                  # 96 suites + 9 Python selftests (~16 min)
...
tests/               96 behaviour suites, mock upstreams, fake DOM
