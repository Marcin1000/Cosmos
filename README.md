...
<p align="center">
  ...
  <img alt="108 test suites" src="https://img.shields.io/badge/test%20suites-108-4ac26b?style=flat-square">
...
**Tests measure behaviour, never source text.** 108 suites plus 9 Python
...
```bash
npm test                  # 108 suites + 9 Python selftests (~16 min)
...
tests/               108 behaviour suites, mock upstreams, fake DOM
