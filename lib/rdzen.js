...
function zapiszAtomowo(file, tresc, opcje = {}) {
  ...
  fs.writeFileSync(tmp, tresc, opcje.mode ? { mode: opcje.mode } : undefined);
...
function saveJsonFile(file, data) {
  try { zapiszAtomowo(file, JSON.stringify(data, null, 2)); }
...
module.exports = {
  ...
  ustawStraznikaSilnikow, modelErrorHint, authHeaders, saveJsonFile, zapiszAtomowo, genId, fireflyEnabled, imageProviders, studioTasks,
};
