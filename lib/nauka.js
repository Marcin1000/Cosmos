...
const { DATA_DIR, SECRETS, readJson, sendJson } = require('./rdzen.js');
...
module.exports = {
  genId, handleAutomation, handleLessons, handleProcedures, handleRoutines,
  polacz, routineView, sanitizeStep, saveJsonFile, saveProcedures,
