...
function bladDlaCzlowieka(err) {
  ...
  return { kod: e && e.kod >= 400 && e.kod < 600 ? e.kod : 500, error: `Błąd serwera: ${e ? e.message : 'nieznany'}` };
}
...
function odpowiedzBledemZapisu(res, sendJson, err) {
  ...
  return sendJson(res, kod, { error: kod === 507 ? error : `Nie udało się zapisać: ${err.message}` });
}
...
module.exports = {
  BrakMiejsca, toBrakMiejsca, zBleduDysku, bladDlaCzlowieka, odpowiedzBledemZapisu,
