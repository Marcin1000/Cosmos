...
/* Zdarzenia, które NIE są otoczeniem użytkownika. Dziennik wyszukiwarek
   („SearXNG zawiódł”, „wyszukano: …”) lądował w kontekście jako „to, co
   właśnie widzisz i słyszysz” (agencja, runda 5). Na osi czasu zostają. */
const NIE_OTOCZENIE = new Set(['internet']);

function sceneContext() {
  const recent = recentEvents().filter((e) => !NIE_OTOCZENIE.has(e.type));
