    ...
    if (payload.usePlan !== false && krotko && userWspolrzedne) {
      extras.push({
        ...
        content:
          ...
          + 'albo ustawienia aparatu NIE zgaduj godzin. Zakończ odpowiedź osobną linią '
          + '[PLAN: tryb=zdjecie] albo [PLAN: tryb=wideo miejsce=Kraków kiedy=2026-06-21T19:30]. '
    ...
    if (payload.useSearch !== false && !bezNarzedzi) {
      extras.push({
        ...
        content: krotko
          ...
          'Znaczników może być kilka w jednej odpowiedzi (do dziesięciu). W jednym ' +
          'łącz średnikiem tylko to, co dotyczy TEGO SAMEGO punktu planu.\n' +
          /* Model pisze znacznik jako punkt listy: „- [GRAFIKA: …]". Po jego
             wycięciu zostaje sam myślnik – Marcin: „są też jakieś dodatkowe
             puste punkty". Klient takie sieroty sprząta, ale taniej jest ich
             nie tworzyć. */
          'ZNACZNIK PISZ W OSOBNEJ LINII, nie jako punkt listy i nie w tabeli. ' +
          'Po wycięciu go z tekstu punkt listy zostaje pusty.\n' +
