...
function utworz(katalogDanych) {
  ...
  /* Adresy miniatur z wcześniejszych wersji. Trzymaliśmy je w indeksie, choć
     NIKT ich nie czyta: przeglądarka bierze miniatury z `/api/archive/thumb`,
     bo podpisane adresy Microsoftu i tak wygasają po godzinie. Zmierzone na
     archiwum wielkości Marcinowego: 80,7 MB indeksu, z czego 70,3 MB to same
     te adresy. Czyścimy przy wczytaniu — indeks chudnie ośmiokrotnie przy
     pierwszym restarcie po aktualizacji. */
  let wyczyszczone = 0;
