...
function utworz(katalogDanych) {
  ...
  function zapisz() {
    if (zapisTrwa) { zapisZaległy = true; return zapisObietnica || Promise.resolve(); }
  ...
  return { dodaj, dodajPorcjami, szukaj, zestawienie, podsumowanie, usunZrodlo, zapisz, zapiszZalegle,
