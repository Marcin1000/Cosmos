...
<p align="center">
  ...
  <img alt="122 zestawów testów" src="https://img.shields.io/badge/zestawy%20test%C3%B3w-122-5E9E3A?style=flat-square">
...
**Testy mierzą zachowanie, nigdy tekst źródła.** 122 zestawów plus 9 selftestów
...
```bash
npm test                  # 122 zestawów + 9 selftestów Pythona (~16 min)
...
```bash
npm test                 # 122 zestawów + 9 selftestów Pythona (~12 min)
npm run test:szybkie     # tylko bez przeglądarki (~30 s)
