...
<p align="center">
  ...
  <img alt="113 zestawów testów" src="https://img.shields.io/badge/zestawy%20test%C3%B3w-113-4ac26b?style=flat-square">
...
**Testy mierzą zachowanie, nigdy tekst źródła.** 113 zestawów plus 9 selftestów
...
```bash
npm test                  # 113 zestawów + 9 selftestów Pythona (~16 min)
