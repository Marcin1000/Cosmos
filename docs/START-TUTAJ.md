...
| Podgląd zdjęcia z lustrzanki nadal wolniejszy niż z telefonu | Tak jest i tak zostanie: zmierzone `pobranie` miniatury to **764–1529 ms dla JPG-a i 7408–8210 ms dla RAW-a**. Microsoft musi wygenerować podgląd z RAW-a u siebie, bo w pliku nie ma gotowego. Dlatego Cosmos, gdy tylko może, bierze podgląd z JPG-owego bliźniaka — ale gdy kadr masz wyłącznie w RAW, tych ośmiu sekund nie ma jak ominąć |
